      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24, width: "min(720px, 100%)" }}>
        ...
        <div style={{ background: D.card, border: `1px solid ${D.border}`, borderRadius: 16, padding: 28 }}>
          ...
          {D.background === "radial-multi" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                { label: "Primary Color",   colorKey: "multiColor1", opacityKey: "multiOpacity1", defaultColor: "#a78bfa", defaultOpacity: 0.25 },
                { label: "Secondary Color", colorKey: "multiColor2", opacityKey: "multiOpacity2", defaultColor: "#ffffff", defaultOpacity: 0.15 },
                ...
                <div key={colorKey}>
                  ...
                  <div style={{ fontSize: 11, color: D.textMuted, marginTop: 4 }}>{Math.round((D[opacityKey] || defaultOpacity) * 100)}%</div>
                </div>
              ))}
            </div>
          )}
        ...
        <div style={{ background: D.card, border: `1px solid ${D.border}`, borderRadius: 16, padding: 28 }}>
          ...
          >
            ...
            <div style={{ fontSize: 18, color: D.textMuted, transition: "transform 0.2s", transform: showColors ? "rotate(45deg)" : "none" }}>+</div>
          </button>

          {showColors && (
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              <div style={{ borderTop: `1px solid ${D.border}`, paddingTop: 24 }}>
                <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 16, color: D.text }}>Colors</div>
